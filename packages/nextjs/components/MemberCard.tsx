...
export const MemberCard = ({ member }: { member: Member }) => (
  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-indigo-900 p-5 sm:p-6 flex flex-col items-center text-left transition h-full min-h-[400px]">
    ...
    <div className="font-bold text-lg sm:text-xl mb-2 text-gray-900 dark:text-white text-center">{member.name}</div>
    ...
    <div className="flex gap-3 sm:gap-4 mt-auto">
      <Link href={`/builders/${member.address}`} className="hover:underline text-blue-500 dark:text-blue-300">
        Profile
      </Link>
      {member.github && (
        <a
