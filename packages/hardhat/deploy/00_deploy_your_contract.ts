...
//address of contract batchRegistry
const batchRegistry = "0x8b698d8f63f078369C067d58A4CC4B529F219CF7";

//My EOA address
const owner = "0xba230e7c7E39D09443d8Da0a332DD787BD1352cb";
...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  console.log("\nBatchRegistry deployed to:", await checkIn.getAddress());
